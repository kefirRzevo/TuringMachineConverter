...
struct Tape {
  ...
  static Tape read(std::istream& is, const States& states) {
    ...
    tape_.stateVal_ = states.getStateVal(std::string(std::next(leftBound), rightBound));
    return tape_;
  }
...
public:
  TuringMachine(const States& states, const Tape& tape) : states_(states), tape_(tape) {}
...
public:
  ...
  std::string toString(const std::string& k) const {
    switch (type_) {
      case TagType::Lk: return "L" + k;
      case TagType::Lk0: return "L" + k + "0";
      case TagType::Lk1: return "L" + k + "1";
      case TagType::Rk: return "R" + k;
      case TagType::Rk0: return "R" + k + "0";
      case TagType::Rk1: return "R" + k + "1";
      case TagType::Rkk: return "R" + k + k;
      case TagType::Hk: return "H" + k;
      case TagType::Hk0: return "H" + k + "0";
      case TagType::Hk1: return "H" + k + "1";
    }
  }
};
...
struct TagSystem {
  ...
  void fillHead() {
    switch (queue_.front().getType()) {
      case TagType::Hk0: head_ = false; break;
      case TagType::Hk1: head_ = true; break;
      default: throw std::runtime_error("Queue starts with incorrect tag");
    }
  }
...
public:
  TagSystem(const States& states, const Tape& tape)
  : states_(states) {
